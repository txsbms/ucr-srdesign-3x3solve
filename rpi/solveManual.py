...
def ValidateCube():
    ...
    if ((cube[0][4] != 'W') or (cube[1][4] != 'O') or (cube[2][4] != 'G') or (cube[3][4] != 'R') or (cube[4][4] != 'B') or (cube[5][4] != 'Y')):
        return False
    ...
    if ((cntW != 9) or (cntO != 9) or (cntG != 9) or (cntR != 9) or (cntB != 9) or (cntY != 9)):
        return False
...
def ManualInput():
    ...
    while not (isInputValid):
        faceA = input("Input first face (U): ")
        faceB = input("Input second face (L): ")
        faceC = input("Input third face (F): ")
        faceD = input("Input fourth face (R): ")
        faceE = input("Input fifth face (B): ")
        faceF = input("Input sixth face (D): ")
        ...
        if (ValidateCube()):
            print("Cube input successful.")
            isInputValid = True
        else:
            print("Cube input is invalid! Please try again.")
...
#PrintMoves()
#scrambleMoves = []
#scrambleMoves = scrambleMoves + movesDone
...
print('')
#print("Scramble: ", end='')
#for i in range(len(scrambleMoves)):
#    print(scrambleMoves[i], end='')
#    if (i != (len(scrambleMoves) - 1)):
#        print(' ', end='')
#print('')
